...
function SportsNews() {
  const { sportsArticles, loading } = useContext(NewsContext);
  const [search, setSearch] = useState('');

  if (loading) return <div className="text-center mt-5">Loading sports news...</div>;
  ...
  return (
    <div className="container mt-4">
      <h2 className="mb-4" style={{ color: '#232526', fontWeight: 'bold', letterSpacing: 1.2, textAlign: 'center', fontSize: '2.2rem', fontFamily: 'Montserrat, sans-serif' }}>Sports News</h2>
      {/* شريط البحث */}
      <motion.div
